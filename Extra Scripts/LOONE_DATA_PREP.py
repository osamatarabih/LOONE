...
S65_total_TP = pd.read_csv(
    "./water_quality_S65E_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
...
Flow_df["Outflows"] = Flow_df[
    ["S308_Out", "S77_Out", "S351_Out", "S352_Out", "S354_Out", "INDUST_Out", "L8_Out"]
].sum(axis=1)
TP_names = [
    "S65_TP",
    "S71_TP",
...
for i in range(len(C44RO_df.index)):
    if (
        S79["Q_cmd"].iloc[i] - Flow_df["S77_Out"].iloc[i] + Flow_df["S77_In"].iloc[i]
        < 0
    ):
        C43RO[i] = 0
    else:
...
for i in range(len(C44RO_df.index)):
    if (
        S80["Q_cmd"].iloc[i] - Flow_df["S308_Out"].iloc[i] + Flow_df["S308_In"].iloc[i]
        < 0
    ):
        C44RO[i] = 0
    else:
...
RFVol["RFVol_acft"] = (RF_data["Avg_RF_In"].values / 12) * LO_Stg_Sto_SA_df[
    "SA_acres"
].values
Working_dir = "C:/Work/Research/LOONE/Final_Data_20082023"
os.chdir("%s" % Working_dir)
...
ETVol["ETVol_acft"] = (ET_data["Avg_ET_In"].values / 12) * LO_Stg_Sto_SA_df[
    "SA_acres"
].values
Working_dir = "C:/Work/Research/LOONE/Final_Data_20082023"
os.chdir("%s" % Working_dir)
...
Water_Temp_data["L001_WaterT"] = Water_Temp_data[
    ["L001_H2OT_C_1", "L001_H2OT_C_2", "L001_H2OT_C_3"]
].mean(axis=1)
Water_Temp_data["L005_WaterT"] = Water_Temp_data[
    ["L005_H2OT_C_1", "L005_H2OT_C_2", "L005_H2OT_C_3"]
].mean(axis=1)
Water_Temp_data["L006_WaterT"] = Water_Temp_data[
    ["L006_H2OT_C_1", "L006_H2OT_C_2", "L006_H2OT_C_3"]
].mean(axis=1)
Water_Temp_data["LZ40_WaterT"] = Water_Temp_data[
    ["LZ40_H2OT_C_1", "LZ40_H2OT_C_2", "LZ40_H2OT_C_3"]
].mean(axis=1)
...
WaterT_pred_df["WaterT_pred_Mean"] = WaterT_pred_df[
    ["L001_WaterT_pred", "L005_WaterT_pred", "L006_WaterT_pred", "LZ40_WaterT_pred"]
].mean(axis=1)
...
L001_TP_Inter = pd.read_csv(
    "./water_quality_L001_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
L004_TP_Inter = pd.read_csv(
    "./water_quality_L004_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
L005_TP_Inter = pd.read_csv(
    "./water_quality_L005_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
L006_TP_Inter = pd.read_csv(
    "./water_quality_L006_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
L007_TP_Inter = pd.read_csv(
    "./water_quality_L007_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
L008_TP_Inter = pd.read_csv(
    "./water_quality_L008_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
LZ40_TP_Inter = pd.read_csv(
    "./water_quality_LZ40_PHOSPHATE, TOTAL AS P_Interpolated.csv"
)
...
L001_OP_Inter = pd.read_csv(
    "./water_quality_L001_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
L004_OP_Inter = pd.read_csv(
    "./water_quality_L004_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
L005_OP_Inter = pd.read_csv(
    "./water_quality_L005_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
L006_OP_Inter = pd.read_csv(
    "./water_quality_L006_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
L007_OP_Inter = pd.read_csv(
    "./water_quality_L007_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
L008_OP_Inter = pd.read_csv(
    "./water_quality_L008_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
LZ40_OP_Inter = pd.read_csv(
    "./water_quality_LZ40_PHOSPHATE, ORTHO AS P_Interpolated.csv"
)
...
LO_NO_Clean_Inter = DF_Date_Range(
    LO_NO_Clean_Inter, St_Yr, St_M, St_D, En_Yr, En_M, En_D
)
...
L001_Chla_Inter = pd.read_csv(
    "./water_quality_L001_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
L004_Chla_Inter = pd.read_csv(
    "./water_quality_L004_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
L005_Chla_Inter = pd.read_csv(
    "./water_quality_L005_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
L006_Chla_Inter = pd.read_csv(
    "./water_quality_L006_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
L007_Chla_Inter = pd.read_csv(
    "./water_quality_L007_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
L008_Chla_Inter = pd.read_csv(
    "./water_quality_L008_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
LZ40_Chla_Inter = pd.read_csv(
    "./water_quality_LZ40_CHLOROPHYLL-A, CORRECTED_Interpolated.csv"
)
...
L001_Chla_LC_Inter = pd.read_csv(
    "./water_quality_L001_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
L004_Chla_LC_Inter = pd.read_csv(
    "./water_quality_L004_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
L005_Chla_LC_Inter = pd.read_csv(
    "./water_quality_L005_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
L006_Chla_LC_Inter = pd.read_csv(
    "./water_quality_L006_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
L007_Chla_LC_Inter = pd.read_csv(
    "./water_quality_L007_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
L008_Chla_LC_Inter = pd.read_csv(
    "./water_quality_L008_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
LZ40_Chla_LC_Inter = pd.read_csv(
    "./water_quality_LZ40_CHLOROPHYLL-A(LC)_Interpolated.csv"
)
