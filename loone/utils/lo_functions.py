...
def WSM_Zone(
    Stage_LO, WSM4, WSM3, WSM2, WSM1
):  # Note that here WSM_Zone(i) return value at time step (i) in LO_Model dataFrame.
    WSM = 0
    if Stage_LO < WSM4:
        WSM = 4
    elif Stage_LO < WSM3:
...
def Max_Supply(
    WSM_Zone,
    LOSA_dmd_Dailydmd,
    Pre_defined_Variables_Z1_cutback,
    Pre_defined_Variables_Z2_cutback,
    Pre_defined_Variables_Z3_cutback,
    Pre_defined_Variables_Z4_cutback,
):
    M_S = 0
    if WSM_Zone == 1:
...
def DecTree_Relslevel(
    Zone_Code, Zone_D_Rel_Code, Zone_C_Rel_Code, Zone_B_Rel_Code
):  # Note that DecTree_Relslevel(i) returns value at time step (i+2) in LO_Model dataFrame.
    DTR = 0
    if Zone_Code == 1:
        DTR = 0
    elif Zone_Code == 2:
...
def Release_Level(
    ...
    Zone_Code,
    DecTree_Relslevel,
    Pre_defined_Variables_MaxQstgTrigger,
):
    RL = Prev_RL
    if (
...
def Fraction_of_Zone_height(
    ...
    if Zone_Code == 1 or Zone_Code == 9:
        ...
        FZH = (Stage_LO - ZoneCodeminus1Code) / (
            ZoneCodeCode - ZoneCodeminus1Code + 0.01
        )
    return FZH
...
def ReLevelCode_1(
    Release_Level,
    Pre_defined_Variables_dstar_D1,
    Pre_defined_Variables_dstar_D2,
    Pre_defined_Variables_dstar_D3,
    Pre_defined_Variables_dstar_C,
    Pre_defined_Variables_dstar_B,
):
    Hnur = 0
...
def ReLevelCode_2(
    Release_Level,
    Pre_defined_Variables_astar_D1,
    Pre_defined_Variables_astar_D2,
    Pre_defined_Variables_astar_D3,
    Pre_defined_Variables_astar_C,
    Pre_defined_Variables_astar_B,
):
    Hnur = 0
    if (Release_Level + 2) == 1:
        Hnur = 0
...
def ReLevelCode_3_S80(
    Release_Level,
    Pre_defined_Variables_bstar_S80_D1,
    Pre_defined_Variables_bstar_S80_D2,
    Pre_defined_Variables_bstar_S80_D3,
    Pre_defined_Variables_bstar_S80_C,
    Pre_defined_Variables_bstar_S80_B,
):
    Hnur = 0
    if (Release_Level + 2) == 1:
        Hnur = 1
...
def Outlet2DS_Mult(
    ...
    dh_7days,
    ReLevelCode_1,
    Fraction_of_Zone_height,
    ReLevelCode_2,
    ReLevelCode_3_S80,
    Pre_defined_Variables_Opt_QregMult,
):
    Mult = 0
    if (
...
def Outlet2DSRS(
    Release_Level,
    S80_RegRelRates_Zone_D1,
    S80avgL1,
    Pulses_S_80_L1,
    S80_Mult_2,
    CE_SLE_turns_SLEturn,
    S80_RegRelRates_Zone_D2,
    S80avgL2,
    Pulses_S_80_L2,
    S80_RegRelRates_Zone_D3,
    S80avgL3,
    Pulses_S_80_L3,
    S80_RegRelRates_Zone_C,
    S80_RegRelRates_Zone_B,
    S80_RegRelRates_Zone_A,
):
    S = 0
    if (Release_Level + 2) == 1:
        S = 0
...
def Outlet2DSBS(
    ...
    VLOOKUP1_c,
    StlEst_baseflow,
    Pre_defined_Variables_Option_S80Baseflow,
):
    BS = 0
    if Release_Level == -1:
...
def Outlet2USBK(
    ...
    C44RO,
    S308BK_data,
    Pre_defined_Variables_Opt_S308,
    Pre_defined_Variables_S308BK_Const,
    Pre_defined_Variables_S308_BK_Thr,
):
    S308 = 0
...
def Outlet2USRG_Code(
    ...
    S308RG_data,
    STEST_data,
    Pre_defined_Variables_Option_RegS77S308,
):
    Code_1 = 0
...
def Outlet2USRG(
    ...
    STEST_data,
    Pre_defined_Variables_Opt_S308,
    Pre_defined_Variables_S308RG_Const,
):
    S_1 = 0
    if Pre_defined_Variables_Opt_S308 == 1:
...
def ReLevelCode_3_S77(
    Release_Level,
    Pre_defined_Variables_bstar_S77_D1,
    Pre_defined_Variables_bstar_S77_D2,
    Pre_defined_Variables_bstar_S77_D3,
    Pre_defined_Variables_bstar_S77_C,
    Pre_defined_Variables_bstar_S77_B,
):
    Hnur = 0
    if (Release_Level + 2) == 1:
        Hnur = 1
...
def Outlet1USRS(
    ...
    S77avgL3,
    Pulses_S_77_L3,
    S77_RegRelRates_Zone_C,
    S77_RegRelRates_Zone_B,
    S77_RegRelRates_Zone_A,
    Pre_defined_Variables_Opt_Outlet1DSRG,
):
    S = 0
    if (Release_Level + 2) == 1:
        S = 0
...
def Outlet1USBK(
    ...
    C43RO,
    S77BK_data,
    Pre_defined_Variables_Outlet1USBK_Switch,
    Pre_defined_Variables_Outlet1USBK_Threshold,
):
    Y = 0
...
def Outlet1DSBS(
    ...
    VLOOKUP2_c,
    CalEst_baseflow,
    Pre_defined_Variables_Option_S77Baseflow,
):
    BS = 0
    if Release_Level >= -1:
        if Pre_defined_Variables_Option_S77Baseflow == 0:
...
#     return(BS)
def Outlet1USBS(
    Outlet1DSBS, Outlet1USRS, ROwest, Pre_defined_Variables_Option_S77Baseflow
):
    Z = 0
    if Pre_defined_Variables_Option_S77Baseflow == 0:
...
def Outlet1USEWS(
    Post_AP_EWS,
    CAEST_data,
    Pre_defined_Variables_Outlet1USEWS_Switch,
    Pre_defined_Variables_Opt_AdapProt,
):
    X = 0
...
def Outlet1USREG(
    ...
    Outlet1USBSAP,
    S77RG_data,
    Pre_defined_Variables_Outlet1USREG_Switch,
    Pre_defined_Variables_Option_RegS77S308,
):
    W = 0
...
def Outlet1DS(
    ...
    ROwest,
    Outlet1DS_data,
    Pre_defined_Variables_Outlet1DS_Switch,
):
    S = 0
...
def Choose_WCA(
    RegWCA_data,
    Pre_defined_Variables_Option_RegWCA,
    Pre_defined_Variables_Constant_RegWCA,
):
    Ch = 0
...
def Choose_L8C51(
    RegL8C51_data,
    Pre_defined_Variables_Option_RegL8C51,
    Pre_defined_Variables_Constant_RegL8C51,
):
    Ch = 0
...
def ET(
    ...
    et_open_data,
    ETVOL_data,
    Pre_defined_Variables_ET_Switch,
):
    E = 0
    if Pre_defined_Variables_ET_Switch == 1:
        E = (
            ((et_dry_data / 12) * (466000 - Stage2ar))
            + ((et_litoral_data / 12) * (Stage2marsh))
...
def Choose_WSA_1(
    WSMs_WSM1,
    Pre_defined_Variables_Opt_WSA,
    Pre_defined_Variables_WSAtrig2,
    Pre_defined_Variables_WSAoff2,
):
    Ch1 = 0
...
def Choose_WSA_2(
    WSMs_WSM1,
    Pre_defined_Variables_Opt_WSA,
    Pre_defined_Variables_WSAtrig1,
    Pre_defined_Variables_WSAoff1,
):
    Ch2 = 0
    if Pre_defined_Variables_Opt_WSA == 1:
...
def WSA_MIA(
    ...
    Choose_WSA_2,
    Pre_defined_Variables_Opt_WSA,
    Pre_defined_Variables_WSA_THC,
    Pre_defined_Variables_MIAcap2,
    Pre_defined_Variables_MIAcap1,
):
    WSA = 0
    if (
        Pre_defined_Variables_Opt_WSA == 0
        or Are_WCA_stages_too_low == True
...
def WSA_NNR(
    ...
    Pre_defined_Variables_Opt_WSA,
    Pre_defined_Variables_WSA_THC,
    Pre_defined_Variables_NNRcap2,
    Pre_defined_Variables_NNRcap1,
):
    WSA = 0
    if (
        Pre_defined_Variables_Opt_WSA == 0
...
def Lake_Stage(
    stg2sto_Storage_iplus2, EOD_Stg_data, Pre_defined_Variables_Option_Stage
):
    Sta = 0
